...
export class AppManager {
    ...
    private createCargaison(): void {
        ...
        try {
            switch (this.selectedCargaisonType) {
                case 'maritime':
                    ...
                    cargaison = new Maritime(
                        ...
                        nomNavireInput.value.trim(),
                        portDepartInput.value.trim(),
                        portArriveeInput.value.trim()
                    );
                    break;
                ...
                case 'aerienne':
                    ...
                    cargaison = new Aerienne(
                        ...
                        this.coordinatesArrivee.lat,
                        this.coordinatesArrivee.lng,
                        numeroVolInput.value.trim(),
                        aeroportDepartInput.value.trim(),
                        aeroportArriveeInput.value.trim()
                    );
                    break;
                ...
                case 'routiere':
                    ...
                    cargaison = new Routiere(
                        ...
                        this.coordinatesArrivee.lat,
                        this.coordinatesArrivee.lng,
                        immatriculationInput.value.trim(),
                        nomChauffeurInput.value.trim()
                    );
                    break;
            ...
            this.gestionnaire.ajouterCargaison(cargaison);
        ...
        try {
            const response = await fetch('http://localhost:3002/cargaisons', {
                ...
                body: JSON.stringify({
                    ...
                    coordinatesDepart: {
                        lat: cargaison.getLatitudeDepart(),
                        lng: cargaison.getLongitudeDepart()
                    },
                    coordinatesArrivee: {
                        lat: cargaison.getLatitudeArrivee(),
                        lng: cargaison.getLongitudeArrivee()
                    },
